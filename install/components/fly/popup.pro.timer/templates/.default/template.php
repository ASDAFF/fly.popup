...
<div class="fly_popup_pro_timer <?echo ($arParams['LEFT']=='Y')?'left':'right'?> <?echo ($arParams['TOP']=='Y')?'top':'bottom'?>">
    ...
    <div class="timer">
        <div>
            <span><?=GetMessage("FL_POPUP_TIMER_DAY")?></span><br>
        </div>
        <div>
            <span><?=GetMessage("FL_POPUP_TIMER_HOUR")?></span><br>
        </div>
        <div>
            <span><?=GetMessage("FL_POPUP_TIMER_MINUTES")?></span><br>
        </div>
        <div>
            <span><?=GetMessage("FL_POPUP_TIMER_SECOND")?></span><br>
        </div>
        <div class="clock">
