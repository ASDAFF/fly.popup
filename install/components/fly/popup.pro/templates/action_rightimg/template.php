...
<div id="fly_popup_action">
	...
	<div class="text">
		...
		<a onclick="<?=$arResult['BUTTON_METRIC']?>" target="<?=$arResult['HREF_TARGET']?>" href="<?=$arResult['LINK_HREF']?>" class="flTargetAction going_link"><?=$arResult['LINK_TEXT']?></a>
	</div>
</div>