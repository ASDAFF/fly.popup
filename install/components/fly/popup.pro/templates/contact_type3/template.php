...
<div id="fly_contact_type3">
	...
	<form action="<?=$templateFolder?>/ajax.php" method="POST" onsubmit="sendForm3(this);return false;">
		...
		function sendForm3(f){
			...
			BX.ajax({
				...
				onsuccess: function(data){
					BX("fly_contact_type3").outerHTML=data;
	...
	<script>
		BX.ready(function(){
			flyPopups.currentPopup.popupContainer.className+=' success_send';
			positionBanner();
		});
	</script>
	<?}?>
