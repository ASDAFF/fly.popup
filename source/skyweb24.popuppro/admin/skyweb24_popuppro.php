...
if(!empty($request['id'])){
	...
	$lAdmin->AddHeaders(array(
	  ...
	  array("id"    =>"SITES",
		"content"  =>GetMessage("skyweb24.popuppro_TABLELIST_SITES"),
		"default"  =>false,
	  ),
	  array("id"    =>"MASK_IN",
		"content"  =>GetMessage("skyweb24.popuppro_TABLELIST_MASK_IN"),
		"default"  =>false,
	  ),
	  array("id"    =>"MASK_OUT",
		"content"  =>GetMessage("skyweb24.popuppro_TABLELIST_MASK_OUT"),
		"default"  =>false,
	  )
	));
...
if(empty($idPopup)){
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_SITE")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_SITE_HINT")?>'
			});
			</script>
		</td>
		<td><?=$selectSite?></td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_ACTIVE_FROM")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_ACTIVE_FROM_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_ACTIVE_TO")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_ACTIVE_TO_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_GROUPS")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_GROUPS_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_SHOWONLYPATH")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_SHOWONLYPATH_HINT")?>'
			});
			</script>
		</td>
		<td><textarea name="showOnlyPath" cols="50" rows="5" placeholder="<?=GetMessage("skyweb24.popuppro_TABCOND_SHOWONLYPATH_EXAMPLE")?>"><?=$editArr['showOnlyPath']?></textarea></td>
	</tr>
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_HIDEONLYPATH")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_HIDEONLYPATH_HINT")?>'
			});
			</script>
		</td>
		<td><textarea name="hideOnlyPath" cols="50" rows="5" placeholder="<?=GetMessage("skyweb24.popuppro_TABCOND_HIDEONLYPATH_EXAMPLE")?>"><?=$editArr['hideOnlyPath']?></textarea></td>
	</tr>
	<?/*<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_PATHPRIORITY")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_PATHPRIORITY_HINT")?>'
			});
			</script>
		</td>
		<td>
			<label><input type="radio" name="maskPriority" value="SHOW"<?=$condPathsPriority_show?> /> <span style="display:inline-block; width:200px;"><?=GetMessage("skyweb24.popuppro_TABCOND_PRIORITY_SHOW")?></span></label><br>
			<label><input type="radio" name="maskPriority" value="NOTSHOW"<?=$condPathsPriority_notshow?> /> <span style="display:inline-block; width:200px;"><?=GetMessage("skyweb24.popuppro_TABCOND_PRIORITY_NOTSHOW")?></span></label>
		</td>
	</tr>*/?>
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_AFTERSHOWCOUNTPAGES")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_AFTERSHOWCOUNTPAGES_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_AFTERTIMESECOND")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_AFTERTIMESECOND_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_TIMEINTERVAL")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_TIMEINTERVAL_HINT")?>'
			});
			</script>
		</td>
		<td>
			...
			<?$APPLICATION->IncludeComponent("bitrix:main.clock","",Array(
				...
				"INPUT_TITLE" => GetMessage("skyweb24.popuppro_TABCOND_TIMEINTERVAL_FROM"),
			...
			<?$APPLICATION->IncludeComponent("bitrix:main.clock","",Array(
				...
				"INPUT_TITLE" => GetMessage("skyweb24.popuppro_TABCOND_TIMEINTERVAL_TO"),
				"INIT_TIME" => $period_to,
				"STEP" => "1"
			));?>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_REPEATTIME")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_REPEATTIME_HINT")?>'
			});
			</script>
		</td>
		<td><input type="number" min="0" step="1" name="repeatTime" value="<?=$editArr['repeatTime']?>" />
			...
			<select name="repeatTime_type">
				<option <?=$hour?> value="hour"><?=GetMessage("skyweb24.popuppro_TABCOND_REPEATTYPE_HOUR")?></option>
				<option <?=$day?> value="day"><?=GetMessage("skyweb24.popuppro_TABCOND_REPEATTYPE_DAY")?></option>
				<option <?=$week?> value="week"><?=GetMessage("skyweb24.popuppro_TABCOND_REPEATTYPE_WEEK")?></option>
				<option <?=$month?> value="month"><?=GetMessage("skyweb24.popuppro_TABCOND_REPEATTYPE_MONTH")?></option>
				<option <?=$year?> value="year"><?=GetMessage("skyweb24.popuppro_TABCOND_REPEATTYPE_YEAR")?></option>
			</select>
		</td>
	</tr>
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_ALREADYGOING")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_ALREADYGOING_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<th colspan="2"><?=GetMessage("skyweb24.popuppro_TABCOND_TITLE_EVENTS")?></th>
	</tr>
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_ANCHORVISIBLE")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_ANCHORVISIBLE_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_ONCLICKCLASSLINK")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_ONCLICKCLASSLINK_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<th colspan="2"><?=GetMessage("skyweb24.popuppro_TABCOND_TITLE_SALE")?></th>
	</tr>
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_SALECOUNTPRODUCT")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_SALECOUNTPRODUCT_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_SALESUMMBASKET")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_SALESUMMBASKET_HINT")?>'
			});
			</script>
		</td>
	...
	<tr>
		<td><?=GetMessage("skyweb24.popuppro_TABCOND_SALEIDPRODINBASKET")?>
			...
			new top.BX.CHint({
				...
				preventHide: true,
				min_width: 400,
				hint: '<?=GetMessage("skyweb24.popuppro_TABCOND_SALEIDPRODINBASKET_HINT")?>'
			});
			</script>
		</td>
		<td>
			...
			<a href="javacript:void(0);" class="add_product_field"><?=GetMessage("skyweb24.popuppro_TABCOND_SALEADDPRODUCT")?></a>
		</td>
	</tr>
	<?}?>
	<tr>
		<td colspan="2"><?CAdminMessage::ShowMessage(Array("TYPE"=>"MESSAGE", "MESSAGE"=>GetMessage("skyweb24.popuppro_LOGIC_INFO")));?></td>
	</tr>
	<?$tabControl->Buttons();?>
	...
	<script>
		...
		var popupMessages={
			...
			'titleSetservice':'<?=GetMessage("skyweb24.popuppro_POPUP_SET_SERVICE")?>',
