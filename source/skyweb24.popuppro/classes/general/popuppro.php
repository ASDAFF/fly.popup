...
class popuppro{
	...
	private function getTypesPreset(){
		$type=array(
			...
			'banner'=>array(
				...
				'active'=>true,
				'props'=>array(
					'IMG_1_SRC'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_BANNER_CONTENT_IMG_1_SRC")),
					'LINK_HREF'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_BANNER_CONTENT_LINK_HREF")),
					'POSITION_LEFT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT")),
					'POSITION_RIGHT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT")),
					'POSITION_TOP'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP")),
					'POSITION_BOTTOM'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_BOTTOM")),
					'HREF_TARGET'=>array(
							'type'=>'service',
							'tag'=>'select',
			...
			'video'=>array(
				...
				'props'=>array(
					'LINK_VIDEO'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_VIDEO_CONTENT_LINK_VIDEO")),
					'POSITION_LEFT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT")),
					'POSITION_RIGHT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT")),
					'POSITION_TOP'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP")),
					'POSITION_BOTTOM'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_BOTTOM")),
			...
			'action'=>array(
				...
				'props'=>array(
					'TITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ACTION_CONTENT_TITLE")),
					'IMG_1_SRC'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ACTION_CONTENT_IMG_1_SRC")),
					'SUBTITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ACTION_CONTENT_SUBTITLE")),
					'CONTENT'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ACTION_CONTENT_CONTENT")),
					'LINK_TEXT'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ACTION_CONTENT_LINK_TEXT")),
					'LINK_HREF'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ACTION_CONTENT_LINK_HREF")),
					'BUTTON_METRIC'=>array('type'=>'content','tag'=>'textarea','name'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC'),'hint'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC_HINT')),
					'POSITION_LEFT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT")),
					'POSITION_RIGHT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT")),
					'POSITION_TOP'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP")),
					'POSITION_BOTTOM'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_BOTTOM")),
			...
			'social'=>array(
				...
				'props'=>array(
					'TITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_VIDEO_CONTENT_TITLE")), /*Óáðàòü*/
					'POSITION_LEFT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT")),
					'POSITION_RIGHT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT")),
					'POSITION_TOP'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP")),
					'POSITION_BOTTOM'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_BOTTOM")),
					'COLOR_BG'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_SOCIAL_SERVICE_COLOR_BG")),
					'ID_VK'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_SOCIAL_SERVICE_ID_VK")),
					/* 'ID_FB'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_SOCIAL_SERVICE_ID_FB")), */
					'ID_INST'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_SOCIAL_SERVICE_ID_INST")),
					'ID_ODNKL'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_SOCIAL_SERVICE_ID_ODNKL")),
					/* 'TYPE_VIEW'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_SOCIAL_SERVICE_TYPE_VIEW")), */
					'HREF_TARGET'=>array(
							'type'=>'service',
							'tag'=>'select',
							'name'=>GetMessage("skyweb24.popuppro_HREF_TARGET"),
			...
			'contact'=>array(
				...
				'props'=>array(
					'IMG_1_SRC'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_CONTENT_MAIN_IMG")),
					'TITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_CONTENT_TITLE")),
					'SUBTITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_CONTENT_SUBTITLE")),
					'BUTTON_TEXT'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_CONTENT_BUTTON_TEXT")),
					'BUTTON_METRIC'=>array('type'=>'content','tag'=>'textarea','name'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC'),'hint'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC_HINT')),
					'POSITION_LEFT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT")),
					'POSITION_RIGHT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT")),
					'POSITION_TOP'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP")),
					...
					'EMAIL_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_EMAIL_SHOW"),'block'=>'start'),
					'EMAIL_REQUIRED'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_EMAIL_REQUIRED")),
					'EMAIL_TITLE'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE")),
					'EMAIL_PLACEHOLDER'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PLACEHOLDER"),'block'=>'end'),

					'NAME_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_NAME_SHOW"),'block'=>'start'),
					'NAME_REQUIRED'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_NAME_REQUIRED")),
					'NAME_TITLE'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE")),
					'NAME_PLACEHOLDER'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PLACEHOLDER"),'block'=>'end'),

					'PHONE_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PHONE_SHOW"),'block'=>'start'),
					'PHONE_REQUIRED'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PHONE_REQUIRED")),
					'PHONE_TITLE'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE")),
					'PHONE_PLACEHOLDER'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PLACEHOLDER"),'block'=>'end'),

					'DESCRIPTION_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_DESCRIPTION_SHOW"),'block'=>'start'),
					'DESCRIPTION_REQUIRED'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_DESCRIPTION_REQUIRED")),
					'DESCRIPTION_TITLE'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE")),
					'DESCRIPTION_PLACEHOLDER'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PLACEHOLDER"),'block'=>'end'),

					'USE_CONSENT_SHOW'=>array('type'=>'service',  'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_CONSENT"),'block'=>'start'),
					'CONSENT_LIST'=>array('type'=>'service',  'tag'=>'select', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_CONSENT_LIST"), 'list'=>$this->getConsentList(), 'block'=>'end'),
			...
			'share'=>array(
				...
				'props'=>array(
					...
					'SUBTITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_SHARE_CONTENT_SUBTITLE")),
			...
			'html'=>array(
				...
				'props'=>array(
					//'TITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_SHARE_CONTENT_TITLE")),
					'TEXTAREA'=>array('type'=>'content', 'tag'=>'textarea', 'name'=>GetMessage("skyweb24.popuppro_HTML_CONTENT_TEXTAREA"),'row'=>'10'),
					'POSITION_LEFT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT")),
					'POSITION_RIGHT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT")),
					'POSITION_TOP'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP")),
					'POSITION_BOTTOM'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_BOTTOM")),
			...
			'age'=>array(
				...
				'props'=>array(
					'TITLE'=>array('type'=>'content','name'=>GetMessage('skyweb24.popuppro_AGE_CONTENT_TITLE')),
					'BUTTON_TEXT_Y'=>array('type'=>'content','name'=>GetMessage('skyweb24.popuppro_AGE_CONTENT_BUTTON_Y')),
					'BUTTON_TEXT_N'=>array('type'=>'content','name'=>GetMessage('skyweb24.popuppro_AGE_CONTENT_BUTTON_N')),
					'IMG_1_SRC'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_AGE_CONTENT_MAIN_IMG")),
					'HREF_LINK'=>array('type'=>'content','name'=>GetMessage('skyweb24.popuppro_AGE_CONTENT_HREF_LINK')),
					'POSITION_LEFT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT")),
					'POSITION_RIGHT'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT")),
					'POSITION_TOP'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP")),
					'POSITION_BOTTOM'=>array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_BOTTOM")),
		...
		if(\Bitrix\Main\Loader::IncludeModule('sale')){
			$type['coupon']=array(
				...
				'props'=>array(
					'TITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_COUPON_CONTENT_TITLE")),
					'SUBTITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_COUPON_CONTENT_SUBTITLE")),
					'IMG_1_SRC'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_COUPON_CONTENT_MAIN_IMG")),
					'BUTTON_TEXT'=>array('type'=>'content','name'=>GetMessage("skyweb24.popuppro_COUPON_CONTENT_BUTTON_TEXT")),
					'BUTTON_METRIC'=>array('type'=>'content','tag'=>'textarea','name'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC'),'hint'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC_HINT')),
					'RULE_ID'=>array(
						'type'=>'service',
						'tag'=>'select',
					...
					'EMAIL_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_EMAIL_SHOW"),'block'=>'start'),
					'EMAIL_PLACEHOLDER'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PLACEHOLDER")),
					...
					'EMAIL_NOT_NEW'=>array('type'=>'service','tag'=>'checkbox','name'=>GetMessage('skyweb24.popuppro_CONTACT_UNIQUE'),'hint'=>GetMessage('skyweb24.popuppro_CONTACT_UNIQUE_HINT')),
					'EMAIL_NOT_NEW_TEXT'=>array('type'=>'service','name'=>GetMessage('skyweb24.popuppro_COUPON_CONTENT_EMAIL_NOT_NEW'),'block'=>'end','hint'=>GetMessage('skyweb24.popuppro_COUPON_CONTENT_EMAIL_NOT_NEW_HINT')),
		...
		$type['roulette']=array(
				...
				'props'=>array(
					'TITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ROULETTE_CONTENT_TITLE")),
					'SUBTITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ROULETTE_CONTENT_SUBTITLE")),
					'BUTTON_TEXT'=>array('type'=>'content','name'=>GetMessage("skyweb24.popuppro_ROULETTE_CONTENT_BUTTON_TEXT")),
					'RESULT_TEXT'=>array('type'=>'content','name'=>GetMessage("skyweb24.popuppro_ROULETTE_RESULT_TITLE"),'hint'=>GetMessage('skyweb24.popuppro_ROULETTE_RESULT_HINT')),
					'NOTHING_TEXT'=>array('type'=>'content','name'=>GetMessage("skyweb24.popuppro_ROULETTE_NOTHING_TITLE"),'hint'=>GetMessage('skyweb24.popuppro_ROULETTE_NOTHING_HINT')),
					'BUTTON_METRIC'=>array('type'=>'content','tag'=>'textarea','name'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC'),'hint'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC_HINT')),
				)
			);
		if(\Bitrix\Main\Loader::IncludeModule('sale'))
		...
		$type['roulette']['props']['EMAIL_SHOW']=array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_EMAIL_SHOW"),'block'=>'start');
		$type['roulette']['props']['EMAIL_PLACEHOLDER']=array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PLACEHOLDER"));
		...
		$type['roulette']['props']['EMAIL_NOT_NEW']=array('type'=>'service','tag'=>'checkbox','name'=>GetMessage('skyweb24.popuppro_CONTACT_UNIQUE'),'hint'=>GetMessage('skyweb24.popuppro_CONTACT_UNIQUE_HINT'));
		$type['roulette']['props']['EMAIL_NOT_NEW_TEXT']=array('type'=>'service','name'=>GetMessage('skyweb24.popuppro_ROULETTE_CONTENT_EMAIL_NOT_NEW'),'block'=>'end','hint'=>GetMessage('skyweb24.popuppro_ROULETTE_CONTENT_EMAIL_NOT_NEW_HINT'));
		$type['roulette']['props']['POSITION_LEFT']=array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_LEFT"));
		$type['roulette']['props']['POSITION_RIGHT']=array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_RIGHT"));
		$type['roulette']['props']['POSITION_TOP']=array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_TOP"));
		$type['roulette']['props']['POSITION_BOTTOM']=array('type'=>'positionpopup', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_POSITION_BOTTOM"));
		$type['discount']=array(
			'code'=>'discount',
			...
			'props'=>array(
				'TITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ROULETTE_CONTENT_TITLE")),
				'SUBTITLE'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_ROULETTE_CONTENT_SUBTITLE")),
				'IMG_1_SRC'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_DISCOUNT_IMG_1")),
				'IMG_2_SRC'=>array('type'=>'content', 'name'=>GetMessage("skyweb24.popuppro_DISCOUNT_IMG_2")),
				'BUTTON_TEXT'=>array('type'=>'content','name'=>GetMessage("skyweb24.popuppro_ROULETTE_CONTENT_BUTTON_TEXT")),
				'BUTTON_METRIC'=>array('type'=>'content','tag'=>'textarea','name'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC'),'hint'=>GetMessage('skyweb24.popuppro_BUTTON_METRIC_HINT')),
				'RULE_ID'=>array(
					'type'=>'content',
				...
				'DISCOUNT_MASK'=>array('type'=>'content','name'=>GetMessage('skyweb24.popuppro_DISCOUNT_MASK_TITLE'),'hint'=>GetMessage('skyweb24.popuppro_DISCOUNT_MASK_TITLE_HINT')),
				'USER_GROUP'=>array(
					'type'=>'content',
					'tag'=>'select',
				...
				'NAME_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_NAME_SHOW"),'block'=>'start'),
				'NAME_REQUIRED'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_NAME_REQUIRED")),
				'NAME_TITLE'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE"),'block'=>'end'),
				
				
				'LASTNAME_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_DISCOUNT_LASTNAME_SHOW"),'block'=>'start'),
				'LASTNAME_REQUIRED'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_DISCOUNT_LASTNAME_REQUIRED")),
				'LASTNAME_TITLE'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE"),'block'=>'end'),
				

				'PHONE_SHOW'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PHONE_SHOW"),'block'=>'start'),
				'PHONE_REQUIRED'=>array('type'=>'service', 'tag'=>'checkbox', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_PHONE_REQUIRED")),
				'PHONE_TITLE'=>array('type'=>'service', 'name'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE"),'block'=>'end'),
				...
				'EMAIL_NOT_NEW'=>array('type'=>'service','tag'=>'checkbox','name'=>GetMessage('skyweb24.popuppro_CONTACT_UNIQUE'),'hint'=>GetMessage('skyweb24.popuppro_CONTACT_UNIQUE_HINT')),
				'EMAIL_NOT_NEW_TEXT'=>array('type'=>'service','name'=>GetMessage('skyweb24.popuppro_ROULETTE_CONTENT_EMAIL_NOT_NEW'),'block'=>'end','hint'=>GetMessage('skyweb24.popuppro_ROULETTE_CONTENT_EMAIL_NOT_NEW_HINT')),
	...
	protected function getTemplatesPreset(){
		$templates=array(
			...
			'contact'=>array(
				array(
					...
					'color_style'=>'green',
					'props'=>array(
						'TITLE'=>GetMessage("skyweb24.popuppro_CONTACT_TITLE"),
				...
				array(
					...
					'props'=>array(
						...
						/*'IMG_1_SRC'=>'/bitrix/themes/.default/skyweb24.popuppro/preload/contact_2.jpg',*/
			...
			'share'=>array(
				array(
					...
					'active'=>true,
					'props'=>array(
						'TITLE'=>GetMessage("skyweb24.popuppro_SHARE_CONTENT_TITLE"),
						'SUBTITLE'=>GetMessage("skyweb24.popuppro_SHARE_CONTENT_SUBTITLE"),
						'SOC_VK'=>'Y',
						'SOC_FB'=>'Y',
						'SOC_OD'=>'Y',
						'SOC_TW'=>'Y',
		...
		$templates['roulette'][0]['props']['EMAIL_PLACEHOLDER']=GetMessage("skyweb24.popuppro_TYPE_ROULETTE_PLACEHOLDER_DEFAULT");
		$templates['roulette'][0]['props']['EMAIL_ADD2BASE']='N';
		$templates['roulette'][0]['props']['EMAIL_NOT_NEW']='N';
		$templates['roulette'][0]['props']['EMAIL_NOT_NEW_TEXT']=GetMessage('skyweb24.popuppro_COUPON_CONTENT_EMAIL_NOT_NEW_DEFAULT');
	...
	public function insertToMailList($mail, $name, $idPopup=0){
		...
		if($tmpPopup>0){
			...
			//groupId
			$groupList=\Bitrix\Sender\ListTable::GetList(array(
				'filter'=>array('CODE'=>'skyweb24PopupPro_'.$tmpPopup)
			));
			if(!$row=$groupList->fetch()){
				$listAddDb = \Bitrix\Sender\ListTable::add(array(
					'NAME' => $rowPopup['service_name'],
	...
	*/
	public static function insertPopups(){
		if(!defined('ADMIN_SECTION') && empty($_SERVER['HTTP_X_REQUESTED_WITH'])){
			...
			if(\Bitrix\Main\Loader::includeModule('sale')){
				$skyweb24Popups['basket']=self::GetBasketInfo();
			}
		...
		while($row = $res->Fetch()){
			...
			foreach($tmpPropsCondition as $nextCond){
				//if(!empty($settings['condition'][$nextCond])){
					if($nextCond=='afterTimeSecond' && !empty($_SESSION['skwb24_popuppro_afterTimeSecond'])){
						$settings['condition'][$nextCond]=$settings['condition'][$nextCond]-(time()-$_SESSION['skwb24_popuppro_afterTimeSecond']);
					}
