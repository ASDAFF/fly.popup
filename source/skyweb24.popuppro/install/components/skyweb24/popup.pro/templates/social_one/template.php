...
?>
<div id="skyweb24_banner_default" style="background:<?=$arResult['COLOR_BG']?>;">
	...
	?>
		<img src="<?=$templateFolder?>/img/<?=$img?>">
			...
			<script  type="text/javascript" >
				...
				vkEl = document.getElementById('skyweb24_vk_groups');
				if(vkEl){
					vkEl.innerHTML='';
				}
				vk_js.onload = vk_js.onreadystatechange = function () {
					VK.Widgets.Group('skyweb24_vk_groups', {mode: 5, width:'auto', height:'316'}, '<?=$arResult['ID_VK']?>');
				}
			</script>
