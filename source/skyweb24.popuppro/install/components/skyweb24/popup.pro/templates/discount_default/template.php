...
<div class="skyweb24_discount" id="skyweb24_discount">
    <link href="https://fonts.googleapis.com/css?family=Old+Standard+TT" rel="stylesheet">
    <div class="background"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span></div>
    <div class="card">
    ...
    <div class="content">
        ...
        <form method="POST" onsubmit="getCoupon(this);return false;">
        <fieldset>
			<?
...
<script>
	...
	function getCoupon(f){
		var url = "<?=$templateFolder?>/ajax.php?id=<?=$arResult['RULE_ID']?>";
		...
		url+="&email="+email.value+"&idPopup=<?=$arParams['ID_POPUP']?>&addtotable=<?=$arResult['EMAIL_ADD2BASE']?>&unique=<?=$arResult['EMAIL_NOT_NEW']?>&MASK=<?=str_replace('#','%23',$arResult['DISCOUNT_MASK'])?>&group=<?=$arResult['USER_GROUP']?>";
